...
Internal method for analysing models using CmdStanR's optimization. This
method is dispatched when `stan_engine = "cmdstan-optimize"` in
[`embr::analyse.mb_model()`](https://rdrr.io/pkg/embr/man/analyse.html).

## Usage

``` r
# S3 method for class 'cmdstan_optimize_model'
analyse1(
  model,
  data,
  loaded,
